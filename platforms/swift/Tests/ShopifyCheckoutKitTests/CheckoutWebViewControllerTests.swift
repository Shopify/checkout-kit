...
class CheckoutWebViewControllerTests: XCTestCase {
    ...
    func test_presentationControllerDidDismiss_doesNotCleanUpBeforeViewDisappears() throws {
        ...
        let viewController = TestableCheckoutWebViewController(checkoutURL: CheckoutTransport.url(for: url, delegations: CheckoutProtocol.defaultDelegations), entryPoint: nil)
