...
class UserAgentTests: XCTestCase {
    func test_string_withAcceleratedCheckoutsEntryPoint_shouldReturnCorrectUserAgent() {
        ...
        XCTAssertEqual(
            ...
            "ShopifyCheckoutKit/4.0.0-alpha.6 (iOS;Swift \(SwiftVersion.current!)) AcceleratedCheckouts"
        )
    }
    ...
    func test_string_withAcceleratedCheckoutsAndReactNativePlatform_shouldReturnUserAgentWithPlatform() {
        ...
        XCTAssertEqual(
            acceleratedCheckoutsUA,
            "ShopifyCheckoutKit/4.0.0-alpha.6 (iOS;Swift \(SwiftVersion.current!)) ReactNative AcceleratedCheckouts"
        )
    }
    ...
    func test_string_withReactNativePlatformAndVersion_shouldReturnUserAgentWithPlatformVersion() {
        ...
        XCTAssertEqual(
            acceleratedCheckoutsUA,
            "ShopifyCheckoutKit/4.0.0-alpha.6 (iOS;Swift \(SwiftVersion.current!)) ReactNative/0.74.5 AcceleratedCheckouts"
        )
    }
    ...
    func test_string_withoutEntryPoint_shouldReturnBasicUserAgent() {
        ...
        XCTAssertEqual(
            checkoutKitUA, "ShopifyCheckoutKit/4.0.0-alpha.6 (iOS;Swift \(SwiftVersion.current!))"
        )
    }
}
