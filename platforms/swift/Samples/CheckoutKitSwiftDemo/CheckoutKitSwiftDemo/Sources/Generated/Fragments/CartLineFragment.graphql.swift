...
extension Storefront {
  nonisolated struct CartLineFragment: Storefront.SelectionSet, Fragment {
    ...
    nonisolated struct Merchandise: Storefront.SelectionSet {
      let __data: DataDict
      init(_dataDict: DataDict) { __data = _dataDict }
      ...
      nonisolated struct AsProductVariant: Storefront.InlineFragment {
        let __data: DataDict
        init(_dataDict: DataDict) { __data = _dataDict }
        ...
        ///
        /// Parent Type: `Image`
        nonisolated struct Image: Storefront.SelectionSet {
          let __data: DataDict
          init(_dataDict: DataDict) { __data = _dataDict }
        ...
        ///
        /// Parent Type: `Product`
        nonisolated struct Product: Storefront.SelectionSet {
          let __data: DataDict
          init(_dataDict: DataDict) { __data = _dataDict }
