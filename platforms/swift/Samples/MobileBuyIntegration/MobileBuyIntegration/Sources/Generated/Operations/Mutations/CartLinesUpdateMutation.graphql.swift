...
extension Storefront {
  nonisolated struct CartLinesUpdateMutation: GraphQLMutation {
    ...
    nonisolated struct Data: Storefront.SelectionSet {
      ...
      nonisolated struct CartLinesUpdate: Storefront.SelectionSet {
        let __data: DataDict
        init(_dataDict: DataDict) { __data = _dataDict }
        ...
        ///
        /// Parent Type: `Cart`
        nonisolated struct Cart: Storefront.SelectionSet {
          let __data: DataDict
          init(_dataDict: DataDict) { __data = _dataDict }
        ...
        nonisolated struct UserError: Storefront.SelectionSet {
          let __data: DataDict
          init(_dataDict: DataDict) { __data = _dataDict }
