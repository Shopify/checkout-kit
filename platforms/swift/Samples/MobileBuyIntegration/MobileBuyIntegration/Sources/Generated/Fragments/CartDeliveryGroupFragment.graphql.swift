...
extension Storefront {
  nonisolated struct CartDeliveryGroupFragment: Storefront.SelectionSet, Fragment {
    ...
    nonisolated struct DeliveryAddress: Storefront.SelectionSet {
      let __data: DataDict
      init(_dataDict: DataDict) { __data = _dataDict }
    ...
    nonisolated struct DeliveryOption: Storefront.SelectionSet {
      let __data: DataDict
      init(_dataDict: DataDict) { __data = _dataDict }
      ...
      ///
      /// Parent Type: `MoneyV2`
      nonisolated struct EstimatedCost: Storefront.SelectionSet {
        let __data: DataDict
        init(_dataDict: DataDict) { __data = _dataDict }
    ...
    ///
    /// Parent Type: `CartDeliveryOption`
    nonisolated struct SelectedDeliveryOption: Storefront.SelectionSet {
      let __data: DataDict
      init(_dataDict: DataDict) { __data = _dataDict }
