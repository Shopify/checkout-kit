...
extension Storefront {
  nonisolated struct CartFragment: Storefront.SelectionSet, Fragment {
    ...
    nonisolated struct BuyerIdentity: Storefront.SelectionSet {
      let __data: DataDict
      init(_dataDict: DataDict) { __data = _dataDict }
      ...
      nonisolated struct Customer: Storefront.SelectionSet {
        let __data: DataDict
        init(_dataDict: DataDict) { __data = _dataDict }
    ...
    nonisolated struct DeliveryGroups: Storefront.SelectionSet {
      let __data: DataDict
      init(_dataDict: DataDict) { __data = _dataDict }
    ...
    nonisolated struct Lines: Storefront.SelectionSet {
      let __data: DataDict
      init(_dataDict: DataDict) { __data = _dataDict }
    ...
    nonisolated struct Cost: Storefront.SelectionSet {
      let __data: DataDict
      init(_dataDict: DataDict) { __data = _dataDict }
      ...
      ///
      /// Parent Type: `MoneyV2`
      nonisolated struct TotalAmount: Storefront.SelectionSet {
        let __data: DataDict
        init(_dataDict: DataDict) { __data = _dataDict }
      ...
      ///
      /// Parent Type: `MoneyV2`
      nonisolated struct SubtotalAmount: Storefront.SelectionSet {
        let __data: DataDict
        init(_dataDict: DataDict) { __data = _dataDict }
      ...
      ///
      /// Parent Type: `MoneyV2`
      nonisolated struct TotalTaxAmount: Storefront.SelectionSet {
        let __data: DataDict
        init(_dataDict: DataDict) { __data = _dataDict }
