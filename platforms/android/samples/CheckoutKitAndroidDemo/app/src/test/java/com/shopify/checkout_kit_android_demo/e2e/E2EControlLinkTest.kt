...
class E2EControlLinkTest {
    ...
    fun `returns null when the link is not a control link`() {
        ...
        assertThat(E2EControlLink.parse("com.shopify.checkout_kit_android_demo://products/1")).isNull()
    ...
    private fun parse(path: String) = E2EControlLink.parse("com.shopify.checkout_kit_android_demo://e2e$path")
