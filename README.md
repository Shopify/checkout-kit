...
- Swift and Android are currently `4.0.0-alpha.2`; React Native is currently `4.0.0-alpha.3`.
...
<!-- e2e trigger-map check: root README must not start the Bitrise e2e pipeline -->
