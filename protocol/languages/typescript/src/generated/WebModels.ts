...
export interface UcpMetadata {
     ...
     */
    capabilities?: { [key: string]: UcpCapability[] };
    /**
     * Payment handler registry keyed by reverse-domain name.
     */
    payment_handlers: { [key: string]: UcpPaymentHandler[] };
    /**
     * Service registry keyed by reverse-domain name.
     */
    services?: { [key: string]: UcpService[] };
    /**
...
export interface UcpObject {
     ...
     * Payment handler registry keyed by reverse-domain name.
     */
    payment_handlers?: { [key: string]: PaymentHandlerElement[] };
    /**
     * Service registry keyed by reverse-domain name.
     */
    services?: { [key: string]: UcpServiceObject[] };
    /**
     * Application-level status of the UCP operation.
     */
    status:  UcpMetadataStatus;
