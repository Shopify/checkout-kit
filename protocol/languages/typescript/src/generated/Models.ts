...
export interface ConstraintProperty {
     ...
     * constraint.
     */
    properties?: { [key: string]: ConstraintProperty };
    /**
...
const typeMap: any = {
    "Checkout": o([
        { json: "actions", js: "actions", typ: u(undefined, m(a(m("any")))) },
        ...
        { json: "policies", js: "policies", typ: u(undefined, a(r("Policy"))) },
    ...
    "Context": o([
        ...
        { json: "payment", js: "payment", typ: u(undefined, a(r("PreferredPaymentHandler"))) },
    ], "any"),
    "PreferredPaymentHandler": o([
    ...
    "Item": o([
        ...
        { json: "quantity_unit", js: "quantityUnit", typ: u(undefined, r("QuantityUnit")) },
        { json: "title", js: "title", typ: "" },
        { json: "unit_price", js: "unitPrice", typ: u(undefined, r("UnitPrice")) },
    ], "any"),
    "QuantityUnit": o([
        { json: "display_text", js: "displayText", typ: "" },
        { json: "scale", js: "scale", typ: u(undefined, 0) },
        { json: "unit", js: "unit", typ: "" },
        { json: "increment", js: "increment", typ: u(undefined, 0) },
    ], "any"),
    "UnitPrice": o([
        { json: "amount", js: "amount", typ: 0 },
        { json: "currency", js: "currency", typ: "" },
        { json: "measure", js: "measure", typ: r("Measure") },
        { json: "reference", js: "reference", typ: r("Measure") },
    ], "any"),
    "Measure": o([
        { json: "display_text", js: "displayText", typ: "" },
        { json: "scale", js: "scale", typ: u(undefined, 0) },
    ...
    "Policy": o([
        { json: "applies_to", js: "appliesTo", typ: u(undefined, a("")) },
    ...
    "UcpCheckoutResponseSchema": o([
        ...
        { json: "map_order", js: "mapOrder", typ: u(undefined, m(a(""))) },
    ...
    "PaymentHandlerResponseSchemaAvailableInstrument": o([
        { json: "constraints", js: "constraints", typ: u(undefined, r("ConstraintExpression")) },
        { json: "type", js: "type", typ: "" },
    ], "any"),
    "ConstraintProperty": o([
        { json: "anyOf", js: "anyOf", typ: u(undefined, a(r("ConstraintExpression"))) },
        { json: "properties", js: "properties", typ: u(undefined, m(r("ConstraintProperty"))) },
        { json: "required", js: "required", typ: u(undefined, a("")) },
        { json: "const", js: "const", typ: u(undefined, "any") },
        { json: "enum", js: "enum", typ: u(undefined, a("any")) },
    ], false),
    "ConstraintExpression": o([
        { json: "anyOf", js: "anyOf", typ: u(undefined, a(r("ConstraintExpression"))) },
        { json: "properties", js: "properties", typ: u(undefined, m(r("ConstraintProperty"))) },
        { json: "required", js: "required", typ: u(undefined, a("")) },
    ], false),
    ...
    "AdjustmentLineItem": o([
        { json: "id", js: "id", typ: "" },
        { json: "measure", js: "measure", typ: u(undefined, r("Measure")) },
        { json: "quantity", js: "quantity", typ: 0 },
    ], "any"),
    "Fulfillment": o([
    ...
    "Expectation": o([
        ...
        { json: "method_type", js: "methodType", typ: "" },
    ], "any"),
