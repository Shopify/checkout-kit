...
const typeMap: any = {
    ...
    "PaymentHandlerResponseSchemaAvailableInstrument": o([
        { json: "constraints", js: "constraints", typ: u(undefined, r("ConstraintsElement")) },
        { json: "type", js: "type", typ: "" },
    ], "any"),
    "PropertyValue": o([
        { json: "anyOf", js: "anyOf", typ: u(undefined, a(r("ConstraintsElement"))) },
        { json: "properties", js: "properties", typ: u(undefined, m(r("PropertyValue"))) },
