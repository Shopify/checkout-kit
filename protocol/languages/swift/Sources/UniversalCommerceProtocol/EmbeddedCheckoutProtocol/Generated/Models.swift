...
public struct FulfillmentGroup: Codable, Sendable {
    ...
    private static let knownAdditionalPropertyKeys: Set<String> = ["id", "line_item_ids", "options", "selected_option_id"]
...
public struct SelectedPaymentInstrument: Codable, Sendable {
    ...
    private static let knownAdditionalPropertyKeys: Set<String> = ["billing_address", "credential", "display", "handler_id", "id", "type", "selected"]
...
public struct PaymentCredential: Codable, Sendable {
    ...
    private static let knownAdditionalPropertyKeys: Set<String> = ["type"]
...
public struct UCPCheckoutResponseSchema: Codable, Sendable {
    ...
    public init(capabilities: [String: [CapabilityResponseSchema]]?, mapOrder: [String: [String]]?, paymentHandlers: [String: [PaymentHandlerResponseSchema]], services: [String: [ServiceResponseSchema]]?, status: UCPCheckoutResponseSchemaStatus?, version: String) {
...
public extension PaymentHandlerResponseSchemaAvailableInstrument {
    ...
    func with(
        constraints: ConstraintsElement?? = nil,
        type: String? = nil
...
public struct PropertyValue: Codable, Sendable {
    ...
    /// the alternation.
    public let anyOf: [ConstraintsElement]?
    ...
    public let constraintExpressionEnum: [JSONAny]?

    public enum CodingKeys: String, CodingKey {
        case anyOf, properties
        case constraintExpressionRequired = "required"
        case const
        case constraintExpressionEnum = "enum"
    }

    public init(anyOf: [ConstraintsElement]?, properties: [String: PropertyValue]?, constraintExpressionRequired: [String]?, const: JSONAny?, constraintExpressionEnum: [JSONAny]?) {
        self.anyOf = anyOf
        self.properties = properties
        self.constraintExpressionRequired = constraintExpressionRequired
        self.const = const
        self.constraintExpressionEnum = constraintExpressionEnum
    }
}

// MARK: PropertyValue convenience initializers and mutators

public extension PropertyValue {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(PropertyValue.self, from: data)
    }
    ...
    func with(
        ...
        return PropertyValue(
            ...
            constraintExpressionEnum: constraintExpressionEnum ?? self.constraintExpressionEnum
        )
    }
...
/// A closed JSON Schema Draft 2020-12 constraint expression with Object and Value Constraint
/// positions.
// MARK: - ConstraintsElement
public struct ConstraintsElement: Codable, Sendable {
    /// Alternative Object Constraints. The constrained object must satisfy at least one. A
    /// branch must be non-empty: an empty branch is satisfied by every object and neutralizes
    /// the alternation.
    public let anyOf: [ConstraintsElement]?
    ...
    public init(anyOf: [ConstraintsElement]?, properties: [String: PropertyValue]?, constraintExpressionRequired: [String]?) {
        self.anyOf = anyOf
        self.properties = properties
        self.constraintExpressionRequired = constraintExpressionRequired
    }
...
// MARK: ConstraintsElement convenience initializers and mutators

public extension ConstraintsElement {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(ConstraintsElement.self, from: data)
    }
...
public struct ErrorResponseUcp: Codable, Sendable {
    ...
    public init(capabilities: [String: [CapabilityResponseSchema]]?, mapOrder: [String: [String]]?, paymentHandlers: [String: [PaymentHandlerResponseSchema]]?, services: [String: [Service]]?, status: ErrorStatus, version: String) {
        self.capabilities = capabilities
        self.mapOrder = mapOrder
        self.paymentHandlers = paymentHandlers
        self.services = services
...
public struct InstrumentsChangeResultUcp: Codable, Sendable {
    ...
    public init(capabilities: [String: [CapabilityElement]]?, mapOrder: [String: [String]]?, paymentHandlers: [String: [PaymentHandlerElement]]?, services: [String: [EmbeddedService]]?, status: UCPCheckoutResponseSchemaStatus, version: String) {
        self.capabilities = capabilities
        self.mapOrder = mapOrder
        self.paymentHandlers = paymentHandlers
        self.services = services
